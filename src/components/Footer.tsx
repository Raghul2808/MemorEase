      ...
      <div className="max-w-[1000px] mx-auto">
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-6 sm:gap-8 mb-6 sm:mb-8">
          ...
          <div>
            ...
            <ul className="flex flex-col gap-1.5 sm:gap-2">
              ...
              <li><a href="https://github.com/Raghul2808/MemorEase" target="_blank" rel="noopener noreferrer" className="font-sans text-[12px] sm:text-[13px] text-[#171d2b]/60 hover:text-[#171d2b] transition-colors">GitHub</a></li>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between pt-4 sm:pt-6 border-t border-[#171d2b]/10 gap-3 sm:gap-4">
          ...
          <div className="flex items-center gap-4">
            ...
            <a href="https://github.com/Raghul2808/MemorEase" target="_blank" rel="noopener noreferrer" className="text-[#171d2b]/50 hover:text-[#171d2b] transition-colors" aria-label="GitHub">
